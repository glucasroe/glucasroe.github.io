...
## Uncovering strategy:
My background is in User Experience Design, which deeply informs how I engage with products. I use this toolbox to bridge gaps between end users and whoever is making the product.

### Human centered research
Structured conversations that build an understanding of users true needs, tasks, and environments. I create programs to activate the current customer base to prioritize needs, solve individual problems, and build retention.
